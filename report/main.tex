...
\author{Sujit Silas Armstrong \and Janvi Bharucha \and Amanda Millatt}
\date{\today}
...
% TODO: Amanda to expand the IPW methodology and results.
...
combined with the NHANES survey weights. Covariate balance before and after
weighting was assessed with standardized mean differences (love plot).
\emph{[Preliminary: IPW-adjusted ATE $= 0.191$, bootstrap 95\% CI
$(0.108,\,0.269)$; full write-up to be completed by A.~Millatt.]}
...
models were logistic regressions over the covariates in Table~\ref{tab:covs},
fit with the NHANES exam weights. (To avoid numerical instability, the exam
...
The three estimators agree closely (Table~\ref{tab:methods}). The doubly robust
risk difference was $0.187$ (95\% CI $0.124$--$0.249$), corresponding to a
marginal OR of about $2.1$ and a risk ratio of $1.50$. Reassuringly, the AIPW
estimate's two ingredients computed alone, the plug-in g-formula ($0.162$) and
IPW ($0.182$), bracket the AIPW value, the hallmark of a well-behaved doubly
robust estimate. All three methods indicate that insurance raises the
...
Project repository: \href{https://github.com/}{m235-causal-inference-final-project}.
